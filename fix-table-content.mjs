...
console.log('Fixing table content in Expert CV Help blog post...\n');
...
if (rows[0]) {
  ...
  // Replace the malformed table with proper markdown
  const updatedContent = currentContent.replace(malformedTable, properTable);
  ...
  if (updatedContent !== currentContent) {
    ...
    console.log('✅ Successfully updated table content!');
    console.log('\nOld (malformed):');
    console.log(malformedTable.substring(0, 100) + '...');
    console.log('\nNew (proper markdown):');
