...
const services = [
  ...
  // Packages
  { name: 'Basic Package', description: 'Resume + Cover Letter for entry-level professionals', type: 'package', category: 'Package', tier: null, price: '125.00', originalPrice: '180.00', features: '["Entry Level Resume","Entry Level Cover Letter","ATS-optimized","We work with you until you\'re 100% satisfied","2-5 business days delivery","Save $55"]', active: 1, sortOrder: 20 },
  { name: 'Standard Package', description: 'Resume + Cover Letter + LinkedIn for professionals', type: 'package', category: 'Package', tier: null, price: '185.00', originalPrice: '270.00', features: '["Professional Resume","Professional Cover Letter","LinkedIn Profile Optimisation","We work with you until you\'re 100% satisfied","2-5 business days delivery","Save $85"]', active: 1, sortOrder: 21 },
  { name: 'Premium Package', description: 'Complete career package for executives', type: 'package', category: 'Package', tier: null, price: '255.00', originalPrice: '605.00', features: '["Executive Resume","Executive Cover Letter","LinkedIn Profile Optimisation","We work with you until you\'re 100% satisfied","2-5 business days delivery","Save $350"]', active: 1, sortOrder: 22 },
  // Add-ons
