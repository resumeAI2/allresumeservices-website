...
const caseStudiesToInsert = [
  {
    ...
    challenge: "Michael had 8 years of experience in mining operations but his resume was overly technical and didn't highlight his leadership achievements. He was applying for senior roles at major mining companies but wasn't getting interviews despite his strong background.",
    solution: "We restructured Michael's resume to lead with quantifiable achievements in safety improvements, cost reduction, and team leadership. We emphasized his experience with large-scale operations, regulatory compliance, and cross-functional collaboration. His cover letter was tailored to BHP's values of sustainability and operational excellence.",
    result: "Within 3 weeks of receiving his new resume, Michael secured interviews with three major mining companies including BHP, Rio Tinto, and Fortescue. He accepted a Senior Mining Engineer position at BHP with a 28% salary increase and relocation package to Western Australia.",
  ...
  },
  {
    ...
    clientName: "Sarah L.",
    challenge: "Sarah had spent 6 years in retail banking at a smaller institution and wanted to move to one of the Big Four banks in a leadership capacity. Her resume read like a job description and didn't showcase her customer service excellence or team management skills.",
    solution: "We created a compelling narrative around Sarah's customer satisfaction metrics (98% positive feedback), her success in mentoring junior staff, and her digital banking initiatives. We highlighted her compliance knowledge and risk management experience, which are critical for Commonwealth Bank roles. Her LinkedIn profile was optimized to attract recruiter attention.",
    result: "Sarah received a LinkedIn message from a Commonwealth Bank recruiter within 2 weeks. After a successful interview process, she was offered a Team Leader position in their retail banking division with a 35% salary increase and comprehensive benefits package.",
