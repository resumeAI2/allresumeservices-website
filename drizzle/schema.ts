 ...
 */
export const draft_intake_records = mysqlTable("draft_intake_records", {
  id: int("id").autoincrement().primaryKey(),
  ...
  completed: int("completed").default(0).notNull(), // 0 = draft, 1 = submitted
  reminderSent: int("reminderSent").default(0).notNull(), // Track if reminder email sent
