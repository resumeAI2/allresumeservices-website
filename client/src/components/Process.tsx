  ...
  const steps = [
    {
      ...
      description: "Send us your current resume, cover letter, or LinkedIn profile for a complimentary evaluation. We'll assess its effectiveness and identify areas for improvement."
    },
    {
      icon: DollarSign,
