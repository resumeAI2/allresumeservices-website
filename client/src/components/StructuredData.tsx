  ...
  useEffect(() => {
    ...
    if (type === 'homepage') {
      ...
      schema = {
        ...
        "description": "Expert ATS-Optimised Resumes & Cover Letters that help Australians land interviews and secure their dream jobs. 96% Interview Success Rate.",
        "url": siteUrl,
      ...
      schema = {
        ...
        "@type": "Service",
        "name": serviceName,
        "description": serviceDescription || `Professional ${serviceName} service by All Resume Services`,
        "provider": {
          "@type": "ProfessionalService",
          "name": "All Resume Services",
          "url": siteUrl,
