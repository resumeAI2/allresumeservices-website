  ...
  const schemaData = {
    ...
    "@graph": [
      // Organization
      {
        ...
        "description": "Professional resume, cover letter, and LinkedIn profile writing services with 18+ years experience helping Australians land interviews and secure their dream jobs.",
        "address": {
          "@type": "PostalAddress",
          "addressCountry": "AU",
