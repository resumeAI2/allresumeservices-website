  ...
  const schemaData = {
    ...
    "@graph": [
      // Organization
      {
        ...
        "description": "Professional resume writing, cover letter, LinkedIn profile, and selection criteria services with 18+ years experience helping Australians land interviews and secure their dream jobs.",
        "address": {
          "@type": "PostalAddress",
          "addressCountry": "AU",
