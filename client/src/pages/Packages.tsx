...
const FALLBACK_ITEMS = {
  ...
  addon: [
    { name: 'Rush Delivery (24-48 hours)', type: 'addon', category: 'Add-on', tier: null, price: '$50', originalPrice: null, description: 'Expedited delivery within 24-48 hours', features: ['Priority processing', '24-48 hour turnaround', 'Applies to all items in order'], popular: false },
    { name: '1ST CONSULTATION FREE', type: 'addon', category: 'Add-on', tier: null, price: '$55', originalPrice: null, description: 'One-on-one career consultation with expert - $55 for 30 mins', features: ['30-minute phone call', 'Career strategy discussion', 'Interview preparation tips', 'Personalized advice'], popular: false },
  ],
};
