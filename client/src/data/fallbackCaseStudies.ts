...
export const FALLBACK_CASE_STUDIES: CaseStudyRow[] = [
  ...
  },
  {
    ...
    solution: "We created an ATS-optimised resume that balanced technical depth with business impact. We highlighted Priya's AWS and Azure certifications, her experience with large-scale cloud migrations, and her cost-saving achievements (reduced infrastructure costs by $2.1M annually).",
